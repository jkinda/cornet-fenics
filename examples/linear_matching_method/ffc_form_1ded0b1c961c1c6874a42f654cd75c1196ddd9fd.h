...
#ifndef __FFC_FORM_1DED0B1C961C1C6874A42F654CD75C1196DDD9FD_H
#define __FFC_FORM_1DED0B1C961C1C6874A42F654CD75C1196DDD9FD_H
...
class ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_finite_element_0()
  {
    // Do nothing
  }
...
throw std::runtime_error("// Function evaluate_basis_derivatives not generated (compiled with -fno-evaluate_basis_derivatives)");
  ...
  {
    return new ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_finite_element_0();
  }
...
class ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_dofmap_0: public ufc::dofmap
{
public:

  /// Constructor
  ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_dofmap_0() : ufc::dofmap()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_dofmap_0()
  {
    // Do nothing
  }
  ...
  {
    return new ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_dofmap_0();
  }
...
class ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_cell_integral_0_otherwise() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_cell_integral_0_otherwise()
  {
    // Do nothing
  }
                               ...
                               int cell_orientation) const
  {
    ...
    for (unsigned int ip = 0; ip < 1; ip++)
    {
      ...
      for (unsigned int j = 0; j < 1; j++)
      {
        ...
        A[j] += FE0[0][j]*0.504549157804401/(F0)*W1*det;
      } // end loop over 'j'
    } // end loop over 'ip'
  }
...
class ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_form_0: public ufc::form
{
public:

  /// Constructor
  ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_form_0() : ufc::form()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_form_0()
  {
    // Do nothing
  }
  ...
  virtual const char* signature() const
  {
    return "261b1e3b697f8a3817759f0199ac1c7a83703cf352c03d028ea96acd384a3b7d78b33cffcea08ee8f2050e08c22b0a9ae71ca6929308c6ee199b63726a084204";
  }
  ...
  {
    return new ffc_form_1ded0b1c961c1c6874a42f654cd75c1196ddd9fd_cell_integral_0_otherwise();
  }
