# -*- coding: utf-8 -*-
#
# Numerical tours of continuum mechanics using FEniCS documentation build configuration file, created by
...
#sys.path.insert(0, os.path.abspath('/home/bleyerj/Fenics/toolbox_continuum_mechanics/'))
...
project = u'Numerical tours of continuum mechanics using FEniCS'
copyright = u'2016, Jeremy Bleyer'
